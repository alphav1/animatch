...
import { getScoreComp, compareFavorites, getFavorites } from '../Elements/Functions'
        ...
        <div>
            <body className={hStyle.Background1}>
                ...
                <text className={hStyle.InputField}>
                    ...
                    <br></br>
                    <div> Your shared anime scores: <button onClick={async (e) => setScoreList(await getScoreComp(User1, User2))}> Compare Scores </button> <br></br> {ScoreList.map(data1 => <ResultsTile data={data1} you={User1} friend={User2} />)} </div>
                    <br></br>
